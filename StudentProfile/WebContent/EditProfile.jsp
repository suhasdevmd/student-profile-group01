			...
			<tr>
				<td><table>
						...
						<tr>
							...
							<td><s:textfield name="MName" placeholder="Enter Middle Name"
									theme="simple" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td></td>
							<td><s:submit value="Update" name="UpdateProfile" />
							</td>
						</tr>
					</table> <br>
				</td>
				...
				<td><s:label theme="simple">Interests</s:label>
					<div class="body">
						...
						<s:checkboxlist list="interests" label="Interest List"
							name="selectedInterestList" theme="vertical-checkbox" value="defaultSelected"></s:checkboxlist>
