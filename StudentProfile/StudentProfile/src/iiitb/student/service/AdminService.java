...
public class AdminService {
	...
	public int getUserIdfromPersonalinfo(String selectionModifier){
		...
		try {
			...
			query = "select userID from personalInformation " + selectionModifier;
	...
	public  UserDetails getUser(String selectionModifier) {
		System.out.println("inside Admin Service getUser");
		UserDetails userdetails = new UserDetails();
		try {
			con = DB.getConnection();
			//query = "select * from personalInformation p " + selectionModifier;
			query = "select * from logindetails l,personalinformation p where l.userID=p.userID " + selectionModifier;
			System.out.println("query ="+query);
			rs = DB.readFromDB(query, con);
			while(rs.next()) {
				System.out.println(rs.toString());
