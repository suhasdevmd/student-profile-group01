...
public class AddUser {
	...
	public String execute() {
		...
		//user.setUserID(adminService.getUser(" AND p.rollNumber='" + rollNumber+"'").getUserID());
		user.setUserID(adminService.getUserIdfromPersonalinfo(" where rollNumber='" + rollNumber+"'"));
		System.out.println("after getUserID");
		
		
		System.out.println("UserId:"+user.getUserID());
		
		System.out.println("before insertIntologinDetails");
		userService.insertIntologinDetails(user);
		System.out.println("after insertIntologinDetails");
