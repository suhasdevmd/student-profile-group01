...
public class AddNewsAction extends ActionSupport{
	...
	public String execute(){
		...
		if(newsAuthor.trim().equalsIgnoreCase("")||newsContent.trim().equalsIgnoreCase("")||
				newsTitle.trim().equalsIgnoreCase("")){
			
			addActionError("Kindly fill all the entries!!!!!");
			return "addnewspage";
		...
		if(stat==2){//news already exist
			
			addActionError("This news already exist!!!!!");
			return "addnewspage";
