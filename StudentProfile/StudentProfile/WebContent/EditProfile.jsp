			...
			<table align="center">
				<tr>
					<td><table>
							...
							<tr>
								<td><s:label theme="simple">FirstName*</s:label>
								</td>
								<td><s:textfield name="FName"
										placeholder="Enter First Name" /></td>
							</tr>
							<tr>
								<td><s:label theme="simple">MiddleName</s:label>
								</td>
								<td><s:textfield name="MName"
										placeholder="Enter Middle Name" theme="simple" />
								</td>
							</tr>
							<tr>
								<td><s:label theme="simple">LastName*</s:label>
								</td>
							...
							<tr>
								<td><s:label theme="simple">Secret Question</s:label>
								</td>
								<td><s:textfield name="secretQuestion"
										placeholder="Enter Secret Question" theme="simple" />
								</td>
							</tr>
							<tr>
								<td><s:label theme="simple">Secret answer</s:label>
								</td>
								<td><s:textfield name="secretAnswer"
										placeholder="Enter Secret Answer" theme="simple" />
								</td>
							</tr>
							<tr class="success">
							...
							<tr>
								<td></td>
								<td><s:submit value="Update" name="UpdateProfile" cssClass="button"/>
								</td>
							</tr>
						</table> <br>
					</td>
